  ...
  return (
    <div className="card">
      <ul className="list-group list-group-flush">
        ...
        <li className="list-group-item">
          {props.item.isShell === 0 ? t('Ngày đáo hạn') : t('Ngày đáo hạn dự kiến')}
        ...
        <li className="list-group-item">
          ...
          <p className="float-right">
            <span className="quatity">{currency(props.item.buyValue)} {t('VNĐ')}</span>
          </p>
        </li>
        <li className="list-group-item">
          {t('Tiền nhận sau đầu tư')}
          <p className="float-right">
            <span className="quatity">{currency(props.item.sellValue)} {t('VNĐ')}</span>
          </p>
        </li>
        <li className="list-group-item">
          {t('Lãi suất đầu tư')}
