  ...
  render() {
    ...
    return (
      <div className="section-2">
        <div className=" row">
          <label className="col-5  npdr">{t('day_trading')}</label>
          <div className="col-7">
            <div className="tar">{this.props.date}</div>
          </div>
        </div>
        <div className=" row">
          <label className="col-6  npdr lh42">{t('mass')}</label>
        ...
        <div className=" row">
          <label className="col-5 ">{t('transaction_price_unit')}</label>
          <div className="col-7">
            <div className="tar">
              <span>
        ...
        <div className=" row mgb10">
          <div className="col-5  clb npdr lh25">
            <strong>{t('investment_value')}</strong>
          </div>
          <div className="col-7">
