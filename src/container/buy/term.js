    ...
    <Layout type={1} title="ĐIỀU KHOẢN & ĐIỀU KIỆN MUA TRÁI PHIẾU">
      <div className="bond-detail">
        <div className="bg-white taj">
          ...
          <p>
            <b>1.7 Ngày Giao Dịch</b>: Là ngày MBS chấp nhận Đăng Ký Mua Trái Phiếu của KH được xác
            nhận trên hệ thống của MBS và KH chuyển tiền mua Trái Phiếu thành công.
          </p>
          <p>
          ...
          <p>
            <b>1.9 Giá Trị Giao Dịch</b>: Giá Trị Giao Dịch = Đơn Giá Giao Dịch x Số lượng giao dịch
          </p>
          <p>
            <b>1.10 Thuế, Phí Giao Dịch</b>: Là thuế, phí KH phải trả khi thực hiện giao dịch mua,
          ...
          <p>
            <b>1.13 Giá trị tái đầu tư coupon</b>: là lãi tái đầu tư coupon KH nhận được, tính từ
            ngày Tổ Chức Phát Hành thanh toán coupon đến ngày Trái Phiếu đáo hạn (với giả định KH
            tiếp tục đầu tư khoản coupon nhận được trong thời gian nắm giữ Trái Phiếu).
          </p>
          <p>
            <b>1.14 Giá trị KH nhận được cuối kỳ</b>: Là giá trị KH bán Trái Phiếu cho bên nhận
            chuyển nhượng, hoặc giá trị Tổ Chức Phát Hành Trái Phiếu thanh toán gốc Trái Phiếu tại
            ngày đáo hạn Trái Phiếu, tùy thuộc vào thời hạn KH nắm giữ Trái Phiếu.
          </p>
          <p>
          ...
          <p>
            ...
            : là lãi suất KH nhận được nếu giữ Trái Phiếu đến đáo hạn, tính theo&nbsp;%/năm/Giá trị
          ...
          <p>
            <b>2.6 Thanh toán</b>: KH thực hiện thanh toán cho MBS như quy định tại Mục 2.5 Điều này
            trong Ngày Giao Dịch.
          </p>
          <p>
            <b>2.7 Chuyển nhượng Trái Phiếu</b>: Khi Đăng Ký Mua Trái Phiếu của KH được MBS chấp
            nhận trên hệ thống, MBS và KH chấp thuận chuyển nhượng Trái Phiếu với các nội dung như
            được nêu tại Đề nghị chuyển nhượng Trái Phiếu. Việc chuyển nhượng được thực hiện ngay
            trong Ngày Giao Dịch, sau khi KH đã thanh toán cho MBS như quy định tại mục 2.6 điều
            này. KH trở thành chủ sở hữu Trái Phiếu và được hưởng các quyền, lợi ích từ các Trái
            Phiếu kể từ ngày hoàn thành việc chuyển nhượng Trái Phiếu.
          </p>
          <p>
          ...
          <p>
            ...
            tháng sau khi đáo hạn Trái Phiếu hoặc trong vòng 03 tháng kể từ ngày KH hoàn thành thủ
            tục chuyển nhượng Trái Phiếu cho bên thứ ba.
          </p>
          <p>
          ...
          <p>
            ...
            : theo các quy định của Hợp đồng, KH và MBS sẽ nỗ lực để tự giải quyết tranh chấp thông
            qua đàm phán thiện chí. Trong trường hợp KH và MBS không giải quyết được tranh chấp qua
            thương lượng, bất kỳ bên nào cũng có thể đưa tranh chấp đó ra Tòa án có thẩm quyền của
            Việt Nam để giải quyết.
          </p>
          <p>
            <b>7.5. Hợp đồng này có hiệu lực</b>: kể từ thời điểm MBS chấp nhận Đăng Ký Mua Trái
            Phiếu của KH trên hệ thống cho đến khi KH và MBS đã hoàn tất các nghĩa vụ của mình theo
            Hợp đồng hoặc chấm dứt theo quy định của pháp luật (ngoại trừ Điều 5, Điều 7.2, Điều
            7.3, Điều 7.4 và Điều 7.5 sẽ tiếp tục duy trì hiệu lực kể cả khi Hợp đồng này chấm dứt).
          </p>
          <p>
            <b>7.6. Mọi sửa đổi, bổ sung Hợp đồng này chỉ có hiệu lực </b>: khi KH đề nghị và được
            MBS xác nhận trên hệ thống giao dịch điện tử. Các sửa đổi, bổ sung này sẽ là một phần
            không tách rời của Hợp đồng. Các văn bản hoặc thỏa thuận được giao kết giữa KH và MBS là
            do MBS trực tiếp lập, ban hành cho KH liên quan đến đầu tư Trái Phiếu, không phải là
