    ...
    <Layout type={1} title="ĐIỀU KHOẢN & ĐIỀU KIỆN MUA TRÁI PHIẾU">
      <div className="bond-detail">
        <div className="bg-white taj">
          ...
          <p>
            <b>1.6 Bản Công Bố Thông Tin</b>: Là bản công bố thông tin về Trái Phiếu do Tổ Chức Phát
            Hành ban hành.
          </p>
          <p>
            <b>1.7 Ngày Giao Dịch</b>: Là ngày MBS chấp nhận Đăng Ký Mua Trái Phiếu của Khách hàng
          ...
          <p>
            ...
            : là lợi suất Khách hàng nhận được nếu giữ Trái Phiếu đến đáo hạn, tính
          ...
          <p>
            <b>2.2 Ngày giao dịch</b>: Là Ngày Giao Dịch được nêu tại Đăng Ký Mua Trái Phiếu
          </p>
          <p>
          ...
          <p>
            <b>2.5 Tổng giá trị giao dịch</b>: Là Tổng Giá Trị Giao Dịch được nêu tại Đăng Ký Mua
            Trái Phiếu
          </p>
          <p>
            <b>2.6 Thanh toán</b>: Khách hàng thực hiện thanh toán cho MBS như quy định tại Mục 2.5
            Điều này trong Ngày Giao Dịch.
          </p>
          <p>
            <b>2.7 Chuyển nhượng Trái Phiếu</b>: Khi Đăng Ký Mua Trái Phiếu của Khách hàng được MBS
            chấp nhận trên hệ thống, MBS và Khách hàng chấp thuận giao dịch chuyển nhượng Trái Phiếu
            với các nội dung như được nêu tại Đề nghị chuyển nhượng Trái Phiếu. Sau khi Khách hàng
            thực hiện việc thanh toán cho MBS như quy định tại Mục 2.5 và Mục 2.6 điều này trong
            Ngày Giao Dịch, việc chuyển nhượng Trái Phiếu được MBS và Khách hàng xác định đã hoàn
            thành. Khách hàng trở thành chủ sở hữu Trái Phiếu và được hưởng các quyền, lợi ích từ
            các Trái Phiếu kể từ ngày hoàn thành việc chuyển nhượng Trái Phiếu.
          </p>
          <p>
            <b>2.8 Hủy giao dịch</b>: Giao dịch mua bán Trái Phiếu giữa Khách hàng và MBS sẽ bị hủy
            trong trường hợp Khách hàng không thực hiện thanh toán đúng thời hạn như quy định tại
            Mục 2.6 Điều này.
          </p>
          ...
          <p>
            ...
            hàng và MBS (“Hợp đồng”). Hợp đồng có hiệu lực kể từ thời điểm MBS chấp nhận Đăng Ký Mua
          ...
          <p>
            <b>3.2 Hợp đồng</b>
            &nbsp;được lập và lưu trữ dưới dạng dữ liệu điện tử trên hệ thống của MBS và có giá trị
            như một hợp đồng được ký dưới dạng văn bản.
          </p>
          ...
          <p>
            ...
            cho Khách hàng theo đúng quy định tại Hợp đồng này, Các Văn Kiện Trái Phiếu và quy định
            của pháp luật có liên quan.
          </p>
          <p>
            – MBS được nhận tiền bán Trái Phiếu từ Khách hàng theo Tổng giá trị giao dịch quy định
            tại Điều 2 Các Điều Khoản và Điều Kiện mua Trái Phiếu;
          </p>
          <p>
            – Xác nhận giao dịch đặt mua Trái Phiếu của Khách hàng thành công trên hệ thống (ngoại
            trừ trường hợp do lỗi hệ thống tin nhắn/ email do đường truyền); hiển thị, cung cấp số
            dư Trái Phiếu mà Khách hàng nắm giữ trong trường hợp Khách hàng đã thanh toán đầy đủ,
            thành công cho MBS (trong trường hợp Khách hàng yêu cầu).
          </p>
          <p>
          ...
          <p>
            ...
            chính xác, trung thực và sử dụng thông tin này để thực hiện thủ tục mua, bán Trái Phiếu
            giữa Khách hàng và MBS. Khách hàng đồng ý sử dụng tài khoản ViettelPay của Khách hàng là
          ...
          <p>
            – Trong trường hợp thông tin của Khách hàng thay đổi, Khách hàng có trách nhiệm thông
            báo về các thông tin thay đổi đó cho Tổ Chức Lưu Ký Trái Phiếu theo phương thức mà Tổ
            Chức Lưu Ký Trái Phiếu quy định. Khách hàng hoàn toàn chịu trách nhiệm và các thiệt hại
            phát sinh (nếu có) từ việc chậm thông báo này.
          </p>
          <p>
          ...
          <p>– Khách hàng thừa nhận, cam đoan và bảo đảm với MBS rằng:</p>
          <p>
            (i) Tham vấn với các bên tư vấn: Để bảo vệ quyền lợi cho Khách hàng khi tham gia đầu tư,
            Khách hàng tự chịu trách nhiệm thực hiện (i) tham vấn với các chuyên gia tư vấn về pháp
            lý, thuế, kinh doanh, đầu tư, tài chính và kế toán liên quan đến việc mua Trái Phiếu của
            Khách hàng trong phạm vi mà Khách hàng cho là cần thiết, (ii) tiếp cận, xem xét và
            nghiên cứu tất cả thông tin mà Khách hàng tin tưởng là cần thiết hoặc phù hợp liên quan
            đến việc mua Trái Phiếu của Khách hàng, (iii) nghiên cứu mọi thông tin mà Khách hàng cho
            là thích hợp liên quan đến việc mua Trái Phiếu và tự đưa ra quyết định đầu tư dựa trên
          ...
          <p>
            ...
            Chức Phát Hành đã công bố về đợt phát hành Trái Phiếu và Tổ Chức Phát Hành; (b) đối với
            việc lựa chọn kênh giao dịch Trái Phiếu trên hệ thống giao dịch điện tử, Khách hàng đồng
            ý và xác nhận rằng MBS sẽ không đóng vai trò là bên tư vấn: tài chính, đầu tư, thuế, và
            kế toán liên quan đến việc mua Trái Phiếu của Khách hàng và (c) tất cả các hợp đồng,
            thỏa thuận và tài liệu liên quan đến việc mua Trái Phiếu của Khách hàng được giao kết
          ...
          <p>
            ...
            Trái Phiếu, hoặc bất kỳ cam đoan nào của bất kỳ bên liên kết, người lao động, nhân viên,
            người có thẩm quyền của MBS đưa ra đối với Khách hàng, rõ ràng hoặc ngầm định, đối với
            việc đầu tư vào Trái Phiếu của Khách hàng;
          </p>
          <p>
            (i) Đưa ra quyết định mua Trái Phiếu: Khách hàng có được tất cả các thông tin mà Khách
            hàng tin tưởng là cần thiết hoặc phù hợp để đưa ra quyết định mua Trái Phiếu của Khách
            hàng, bao gồm nhưng không giới hạn các thông tin trong Các Văn Kiện Trái Phiếu, thông
            tin về dòng tiền Trái Phiếu dự kiến … và Khách hàng cũng thừa nhận rằng MBS hoặc bất kỳ
            bên có liên quan của MBS không xác nhận các thông tin đó hoặc đưa ra các khẳng định hoặc
            bảo đảm về tính chính xác và đầy đủ của các thông tin đó;
          </p>
          <p>
            (ii) Kiến thức: Khách hàng đã có sự tìm hiểu, đánh giá độc lập về việc đầu tư Trái Phiếu
            qua hệ thống giao dịch điện tử. Khách hàng có kiến thức về tài chính, kinh doanh và đầu
            tư Trái Phiếu nên Khách hàng có khả năng đánh giá lợi ích và hiểu được các rủi ro của
            việc mua Trái Phiếu và hiểu được rằng Khách hàng có thể phải chịu và có khả năng gánh
            chịu các rủi ro về tài chính phát sinh liên quan đến việc đầu tư vào Trái Phiếu trước
            khi quyết định thực hiện giao dịch;
          </p>
          <p>
            (iii) Xem xét các yếu tố rủi ro: Khách hàng đã xem xét toàn bộ Bản công bố thông tin do
            Tổ Chức Phát Hành công bố, và đặc biệt là phần có tiêu đề “Các Yếu Tố Rủi Ro” hoặc phần
            có nội dung tương tự, và Khách hàng hiểu và thừa nhận tất cả các rủi ro được mô tả trong
            phần “Các Yếu Tố Rủi Ro” hoặc phần có nội dung tương tự của Bản công bố thông tin do Tổ
            Chức Phát Hành công bố. Trên cơ sở nêu trên, Khách hàng đồng ý và thừa nhận rằng:
          </p>
          <p>
            (A) Trái Phiếu là một khoản đầu tư phù hợp cho Khách hàng và khoản đầu tư của Khách hàng
            vào Trái Phiếu không vi phạm bất kỳ luật, quy tắc, quy định nào áp dụng đối với Khách
            hàng; và
          </p>
          <p>
            (B) Khách hàng đã có được tất cả các chấp thuận và phê duyệt nội bộ và/hoặc Khách hàng
            đảm bảo có đủ thẩm quyền để đầu tư vào Trái Phiếu theo Các Điều Khoản và Điều Kiện này.
          </p>
          <p>
            (i) Thay đổi chính sách phân phối Trái Phiếu của MBS: Khách hàng tại đây thừa nhận rằng
            việc đầu tư vào Trái Phiếu có thể bị ảnh hưởng do việc thay đổi chính sách phân phối
            Trái Phiếu theo chính sách, quyết định của MBS công bố từng thời kỳ.
          </p>
          <p>
          ...
          <ul>
            <li>
              Khoản điều chỉnh giảm: Là phần bù lợi nhuận trên các Trái Phiếu Khách hàng đang nắm
              giữ bị Tổ Chức Phát Hành mua lại trước hạn do MBS chi trả cho Khách hàng. Khoản điều
              chỉnh giảm giá mua này chỉ áp dụng đối với các Trái Phiếu được Tổ Chức Phát Hành mua
              lại trước hạn;
            </li>
            <li>
            ...
            <li>
              Lợi nhuận đầu tư: Là lợi nhuận đầu tư tính trên mỗi Trái Phiếu Khách hàng mua từ MBS
              với lợi suất đáo hạn Trái Phiếu tính trên giá trị mua mỗi Trái Phiếu và thời gian đầu
              tư (tính từ (và gồm cả) Ngày Giao Dịch đến (nhưng không bao gồm cả) ngày Tổ Chức Phát
              Hành mua lại Trái Phiếu trước hạn) với cơ sở tính lãi 365 ngày/năm.
            </li>
            <li>
            ...
            <li>
              ...
              Phát Hành thanh toán cho Khách hàng trong thời gian Khách hàng nắm giữ Trái Phiếu;
            </li>
            <li>
              Số lượng Trái Phiếu được mua lại: Là số lượng Trái Phiếu Khách hàng đang nắm giữ được
          ...
          <p>
            ...
            theo điều khoản và điều kiện của Trái Phiếu do Tổ Chức Phát Hành công bố. Trừ trường hợp
            có sai sót rõ ràng về mặt số liệu, Khách hàng và MBS thống nhất số liệu do MBS tính toán
            sẽ là số liệu cuối cùng của Khách hàng và MBS.
          </p>
          <p>
            – Để làm rõ, Khách hàng và MBS thống nhất số lượng Trái Phiếu được Tổ Chức Phát Hành mua
            lại sẽ được tính trên cơ sở các Trái Phiếu được giao dịch tại Hợp đồng này và tại thời
            điểm Tổ Chức
          </p>
          <p>
          ...
          <p>
            <b>
              7.2. Mỗi bên phải giữ bí mật nội dung của Hợp đồng này và chỉ được tiết lộ nội dung
              của Hợp đồng và/hoặc Các Văn Kiện Trái Phiếu (“Thông Tin Mật”) khi
            </b>
            ...
            thủ quy định nội bộ và vận hành khác của MBS. Quy định này vẫn có hiệu lực trong vòng 03
            tháng sau khi đáo hạn Trái Phiếu hoặc trong vòng 03 tháng kể từ ngày Khách hàng hoàn
          ...
          <p>
            <b>
              {' '}
              7.4. Trong trường hợp có bất cứ tranh chấp nào phát sinh liên quan đến việc mua bán
              Trái Phiếu{' '}
            </b>{' '}
            : theo các quy định của Hợp đồng, Khách hàng và MBS sẽ nỗ lực để tự giải quyết tranh
          ...
          <p>
            <b>7.5. Hợp đồng này có hiệu lực</b>: kể từ thời điểm MBS chấp nhận Đăng Ký Mua Trái
            Phiếu của Khách hàng trên hệ thống cho đến khi Khách hàng và MBS đã hoàn tất các nghĩa
            vụ của mình theo Hợp đồng hoặc chấm dứt theo quy định của pháp luật (ngoại trừ Điều 5,
            Điều 7.2, Điều 7.3, Điều 7.4 và Điều 7.5 sẽ tiếp tục duy trì hiệu lực kể cả khi Hợp đồng
            này chấm dứt).
          </p>
          <p>
            <b>7.6. Mọi sửa đổi, bổ sung Hợp đồng này chỉ có hiệu lực </b>: khi Khách hàng đề nghị
            và được MBS xác nhận trên hệ thống giao dịch điện tử. Các sửa đổi, bổ sung này sẽ là một
            phần không tách rời của Hợp đồng. Các văn bản hoặc thỏa thuận được giao kết giữa Khách
            hàng và MBS là do MBS trực tiếp lập, ban hành cho Khách hàng liên quan đến đầu tư Trái
            Phiếu, không phải là thỏa thuận hoặc văn bản được ký, ban hành chấp nhận bởi một bên thứ
            ba nào khác.
          </p>
        </div>
      </div>
