      ...
      <div className="bond-detail">
        <div className="bg-white taj">
          <p>
            ...
            định được nêu tại Các Điều khoản và Điều kiện bán Trái Phiếu sau đây:
          </p>
          ...
          <p>
            <b>1.7. Ngày Giao Dịch</b>: Là ngày KH bán Trái Phiếu.
          </p>
          <p>
          ...
          <p>
            ...
            đầu tư Trái Phiếu&nbsp;trên cơ sở 1 năm có 365 ngày. Giả định Tổ Chức Phát Hành thanh
            toán đúng hạn, đủ gốc, lãi Trái Phiếu và coupon của các kỳ chưa xác định lãi suất được
            giả định như tại&nbsp;Chi tiết dòng tiền.
          </p>
          ...
          <p>
            <b>2.6. Thanh toán</b>: MBS thực hiện thanh toán cho KH như quy định tại Mục 2.5 Điều
            này trước trong Ngày Giao Dịch.
          </p>
          <p>
            <b>2.7. Chuyển nhượng Trái Phiếu</b>: Khi Đăng Ký Bán Trái Phiếu của KH được MBS chấp
            nhận trên hệ thống, KH và MBS chấp thuận chuyển nhượng Trái Phiếu với các nội dung như
          ...
          <p>
            ...
            (“Hợp đồng”). Hợp đồng có hiệu lực kể từ thời điểm MBS chấp nhận Đăng Ký Bán Trái Phiếu
          ...
          <p>
            ...
            : theo các quy định của Hợp đồng này, KH và MBS sẽ nỗ lực để tự giải quyết tranh chấp
          ...
          <p>
            ...
            Hợp đồng hoặcchấm dứt theo quy định của pháp luật (ngoại trừ Điều 5, Điều 6.2, Điều 6.3,
            Điều 6.4 và Điều 6.5sẽ tiếp tục duy trì hiệu lực kể cả khi Hợp đồng này chấm dứt).
          </p>
          <p>
            <b>6.6. Mọi sửa đổi, bổ sung Hợp đồng này chỉ có hiệu lực</b>: khi KH đề nghị và MBS xác
            nhận trên hệ thống. Các sửa đổi, bổ sung này sẽ là một phần không tách rời của Hợp đồng.
            Các văn bản hoặc thỏa thuận được giao kết giữa KH và MBS là do MBS trực tiếp lập, ban
            hành cho KH liên quan đến đầu tư Trái Phiếu, không phải là thỏa thuận hoặc văn bản được
            ký, ban hành chấp nhận bởi một bên thứ ba nào khác.
          </p>
        </div>
      </div>
    </Layout>
